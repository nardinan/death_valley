...
#define d_commands_sleep_fragments 10
#define d_commands_SET(k,d)\
{\
...
extern char v_commands_queue[d_commands_queue][d_string_buffer_size];
...
extern int f_commands_apply(struct s_console *console, struct s_console_command *command, char **tokens, size_t elements, int output);
...
extern int f_commands_sleep(struct s_console *console, struct s_console_command *command, char **tokens, size_t elements, int output);
#endif
